...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bl4-MBwQ.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-QwdJXLEm.mjs"),
		import("./start-XxpbRMmO.mjs"),
		import("./empty-plugin-adapters-BCmWY9su.mjs")
	]);
	return {
		routerEntry,
		startEntry,
